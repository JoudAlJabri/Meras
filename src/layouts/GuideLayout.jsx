...
const navItems = [
  { to: "/guide/dashboard",  label: "Dashboard",       icon: MdDashboard        },
  { to: "/guide/mentors",    label: "Mentor Directory", icon: MdOutlineMenuBook  },
  { to: "/guide/tasks",      label: "Task Wizard",      icon: FaWandMagicSparkles },
  { to: "/guide/grading",    label: "Grading",          icon: MdGrade            },
];
